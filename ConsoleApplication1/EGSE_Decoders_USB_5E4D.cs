...
namespace EGSE.Decoders.USB
{
    ...
    /// </summary>
    public class Decoder5E4D : USBProtocolBase
    {
        private USBProtocolMsg _package;
        private USBProtocolErrorMsg _errorFrame;
        ...
        public Decoder5E4D()
        {
            _package = new USBProtocolMsg(MAX_FRAME_LEN);
            _errorFrame = new USBProtocolErrorMsg(MAX_FRAME_LEN);  
            reset();
        }
        /// <summary>
        ...
        public Decoder5E4D(FileStream fDecStream, TextWriter fEncStream, bool wDecLog, bool wEncLog): this()
        {
            _fDecStream = null;
            _fEncStream = null;
