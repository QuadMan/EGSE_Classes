        ...
        public class Spacewire1 : SubNotify, IDataErrorInfo
        {
            ...
            public bool IsConnect
            {
                ...
                private set 
                {
                    ...
                    ControlValuesList[Global.Spacewire1.Control].SetProperty(Global.Spacewire1.Control.Connect, Convert.ToInt32(value), false);
                    OnPropertyChanged();
                }
            }
        ...
        public class ControlBuk : SubNotify
        {
            ...
            private void DataSend(object obj)
            {
                ...
                try
                {
                    ...
                    Array.Copy(DataBytes, 0, buf, 1, DataBytes.Length);
                    buf[0] = 0x0E;
                    buf[1] = (byte)DataBytes.Length;
            ...
            private void CmdSend(object obj)
            {
                ...
                {                   
                    ...
                    SetSpw2Prop(false, 0x610, true, true, true, new byte[5] { 13, buf[0], buf[1], buf[2], buf[3] });
                }
                finally
                {
                    PopSpw2Prop();
            ...
            private void CmdLight(object obj)
            {
                ...
                try
                {
                    SetSpw2Prop(false, 0x610, true, true, true, new byte[5] { 12, 0, (byte)(LightTime >> 16), (byte)(LightTime >> 8), (byte)LightTime });
                }
                finally
                {
                    PopSpw2Prop();
            ...
            private void CmdShutter(object obj)
            {
                ...
                try
                {
                    SetSpw2Prop(false, 0x610, true, true, true, new byte[5] {11, (byte)((LineShutter << 4) | 0/*NumberShutter*/), (byte)(ShutterTime >> 16), (byte)(ShutterTime >> 8), (byte)ShutterTime });
                }
                finally
                {
                    PopSpw2Prop();
            ...
            private void CmdConfig(object obj)
            {
                ...
                try
                {
                    SetSpw2Prop(false, 0x610, false, true, true, 1 == SelConf ? new byte[5] { 10, SelConf, 0, (byte)((ModeConf << 4) | CompressConf), 0 } : new byte[5] { 10, SelConf, 0, (byte)((Convert.ToByte(ExchangeConf) << 3) | (ActivateConf << 2) | (LineSendConf << 1) | LineRecvConf), 0 });
                }
                finally
                {
                    PopSpw2Prop();
            ...
            private void CmdSelDetector(object obj)
            {
                ...
                try
                {
                    SetSpw2Prop(false, 0x610, true, true, true, new byte[5] { 8, (byte)((Convert.ToByte(PwrDetector) << 4) | SelDetector), 0, 0, 0 });
                }
                finally
                {
                    PopSpw2Prop();
            ...
            private void CmdIndicateDetector(object obj)
            {
                ...
                try
                {
                    SetSpw2Prop(false, 0x610, true, true, true, new byte[5] { 0x0F, (byte)((Convert.ToByte(PwrDetector) << 4) | SelDetector), 0, 0, 0 });
                }
                finally
                {
                    PopSpw2Prop();
            ...
            private void CmdGetTele(object obj)
            {
                ...
                try
                {
                    SetSpw2Prop(false, 0x610, false, false, true, new byte[1] { 5 });
                }
                finally
                {
                    PopSpw2Prop();
            ...
            private void CmdGetFrame(object obj)
            {
                ...
                try
                {
                    SetSpw2Prop(false, 0x610, true, true, true, new byte[5] { 1, Convert.ToByte(IsIssueTest), 0, 0, 0 });
                }
                finally
                {
                    PopSpw2Prop();
            ...
            private void CmdThreshold(object obj)
            {
                ...
                try
                { 
                    SetSpw2Prop(false, 0x610, false, true, true, new byte[5] { 4, AlgoType, (byte)(Threshold >> 8), (byte)Threshold, Param1});
                }
                finally
                {
                    PopSpw2Prop();
        ...
        {         
            ...
            public bool IsConnect
            {
                ...
                private set 
                {
                    ...
                    this.isConnect = value;
                    ControlValuesList[Global.Spacewire2.Control].SetProperty(Global.Spacewire2.Control.Connect, Convert.ToInt32(value), false);
                    OnPropertyChanged();
                }
            }
        ...
        public class Spacewire3 : SubNotify, IDataErrorInfo
        {
            ...
            public bool IsConnect
            {
                ...
                private set 
                {
                    ...
                    this.isConnect = value;
                    ControlValuesList[Global.Spacewire3.Control].SetProperty(Global.Spacewire3.Control.Connect, Convert.ToInt32(value), false);
                    OnPropertyChanged();
                }
            }
        ...
        public class Spacewire4 : SubNotify, IDataErrorInfo
        {
            ...
            public bool IsConnect
            {
                ...
                private set 
                {
                    ...
                    this.isConnect = value;
                    ControlValuesList[Global.Spacewire4.Control].SetProperty(Global.Spacewire4.Control.Connect, Convert.ToInt32(value), false);
                    OnPropertyChanged();
                }
            }
